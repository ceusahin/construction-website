function OurServicesCard({ name, img, description }) {
  return (
    <div className="">
      <div className="grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        <a
          href="/contact"
        ...
        >
          ...
          <div className="relative h-full p-6 flex flex-col justify-between z-20">
            <div>
              <p className="text-2xl font-bold tracking-widest text-blue-300 group-hover:text-blue-700 drop-shadow-md opacity-90 group-hover:opacity-100 transition-opacity duration-300">
                Hizmet
              </p>

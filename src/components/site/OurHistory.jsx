    ...
    <div className="my-12 md:my-20 px-4 md:px-8 xl:mx-36 flex flex-col lg:flex-row gap-12">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-start gap-6">
        ...
        <p className="text-sm md:text-base text-black mt-3">
          The journey started with a simple mission: to create spaces that blend
          functionality with aesthetics. Over the years, experience, innovation,
          and a client-focused approach have fueled growth, enabling the
          completion of projects that leave a lasting impression. This journey
